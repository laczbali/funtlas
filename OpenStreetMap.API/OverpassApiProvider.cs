...
namespace OpenStreetMap.API
{
    ...
    {
        private OverpassApi remoteSource;

        public OverpassApiProvider(OverpassApiConfig? config = null)
        {
            this.remoteSource = new OverpassApi(config ?? new OverpassApiConfig());
        }
